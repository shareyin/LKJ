...
namespace Pengpai.UI
{
    public partial class ZGraph : UserControl
    {
        ...
        /// 当前是否处于可移动模式
        /// </summary>
        public bool _isMoveModeXY = false;
        /// <summary>
        /// 当前是否处于显示坐标模式
        /// </summary>
        ...
        ///记录在拖拽模式下，鼠标的坐标值
        /// </summary>
        public Point _startMouse = new Point();
        /// <summary>
        /// 坐标精确度
        /// </summary>
        private float _fAccuracy = 0.50f;
        /// <summary>
        /// 坐标显示最多小数位数
        /// </summary>
        ...
        /// 要显示的站点名称
        /// 
        private List<List<string>> _StateName = new List<List<string>>();
        /// <summary>
        /// 储存波形信号文件的位置
        /// </summary>
        ...
        private float _fXEndSYS = 5.000f;      //公开
        private float _fYBeginSYS = 0f;     //公开
        private float _fYEndSYS = 140f;       //公开
        ...
        //控件标题描边颜色
        private Color _titleBorderColor = Color.FromArgb(255, 255, 255);

        //背景色渐进起始颜色
        private Color _backColorL = Color.FromArgb(255, 255, 255);
        //背景色渐进终止颜色
        private Color _backColorH = Color.FromArgb(255, 255, 255);

        //坐标线颜色
        private Color _coordinateLineColor = Color.FromArgb(0, 0, 0);
        private Color _XcoordinateLineColor = Color.FromArgb(255, 255, 255);
        //坐标值颜色
        private Color _coordinateStringColor = Color.FromArgb(0, 0, 0);
        private Color _XcoordinateStringColor = Color.FromArgb(255, 255, 255);
        //坐标标题颜色
        private Color _coordinateStringTitleColor = Color.FromArgb(0, 0, 0);
        private Color _XcoordinateStringTitleColor = Color.FromArgb(255, 255, 255);
